 ...
 */
final class Version20260221101240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE suivi_quotidien ADD utilisateur_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE suivi_quotidien DROP utilisateur_id');
    }
}
