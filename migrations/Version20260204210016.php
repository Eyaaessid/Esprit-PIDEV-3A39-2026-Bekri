 ...
 */
final class Version20260204210016 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE suivi_quotidien CHANGE poids poids DOUBLE PRECISION DEFAULT NULL, CHANGE datetime datetime DATETIME DEFAULT NULL');
